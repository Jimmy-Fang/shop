    ...
    $.fn.extend({
        MultDropList: function (options) {
            ...
            return this.each(function () {
                ...
                //加载默认数据
                $list.append('<ul style="list-style-type:none;margin:0;"><li style="margin:0;padding-left: 10px;padding-top: 2px;padding-bottom: 2px;border-top: 1px solid black;"><input type="checkbox" class="selectAll" value="0" /><span style="width:160px;">全部</span></li></ul>');
                var $ul = $list.find("ul");
                ...
                for (var i = 0; i < listArr.length; i++) {
                    ...
                    $ul.append('<li><input type="checkbox" value="' + jsonData.k + '" /><span style="width:160px;">' + jsonData.v + '</span></li>');
                }
