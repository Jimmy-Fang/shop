...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title>系统发生错误 - System error occurs</title>
    <style type="text/css">
        *{ padding: 0; margin: 0; }
...
<div class="copyright">
    <p><a title="精容数安" href="http://www.jingrongshuan.com">精容数安</a><sup><?php echo THINK_VERSION ?></sup> { Fast & Simple OOP PHP Framework } -- [ WE CAN DO ANYTHING ]</p>
</div>
</body>
</html>